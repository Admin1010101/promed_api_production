...
# CRITICAL FIX: SECURE_SSL_REDIRECT must be False for Azure
# Azure App Service handles SSL at the load balancer level. Setting this to True
# causes redirect loops and 403 errors because internal health probes use HTTP.
# HTTPS is enforced via Azure's "HTTPS Only" setting in the portal instead.
SECURE_SSL_REDIRECT = False # Changed from True - THIS IS THE KEY FIX
...
# Consider restricting this to specific domains in production
