...
urlpatterns = [
    ...
    path('provider/verify-email/', api_views.VerifyEmailView.as_view(), name='verify-email'),
    path('provider/reset-password/', api_views.ResetPasswordView.as_view(), name='reset-password'),
